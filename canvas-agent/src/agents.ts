...
class CodexAppClient {
    ...
    static async start(emit: AgentEmit) {
        ...
        await client.request("initialize", { clientInfo: { name: "canvas-agent", title: "HMaigc Canvas Agent", version: VERSION }, capabilities: { experimentalApi: true, requestAttestation: false } });
