...
function MembershipIcon({ className }: { className: string }) {
    return (
        <svg className={`site-membership-icon ${className}`} viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
            ...
            />
            <path
                className="updream-membership-icon-layer updream-membership-icon-layer-2"
            ...
            />
            <path
                className="updream-membership-icon-layer updream-membership-icon-layer-3"
            ...
            />
            <path
                className="updream-membership-icon-layer updream-membership-icon-layer-4"
            ...
            />
            <path
                className="updream-membership-icon-layer updream-membership-icon-layer-5"
            ...
            />
            <path
                className="updream-membership-icon-layer updream-membership-icon-layer-6"
            ...
            />
            <path
                className="updream-membership-icon-layer updream-membership-icon-layer-7"
            ...
            <path
                className="updream-membership-icon-layer updream-membership-icon-layer-9"
            ...
            />
            <path
                className="updream-membership-icon-layer updream-membership-icon-layer-10"
            ...
            />
            <path
                className="updream-membership-icon-layer updream-membership-icon-layer-11"
