...
export function removeLastCanvasAgentSelection({
    models,
    selectedSkills,
}: CanvasAgentSelectionState): CanvasAgentSelectionState | null {
...
export function CanvasAgentSelectionSummary({
    config,
    models,
    selectedSkills,
    disabled,
    onModelsChange,
    onSkillsChange,
}: CanvasAgentSelectionSummaryProps) {
...
function SelectionChip({
    ...
    return (
        <span className="canvas-agent-selection-chip" title={label}>
            <span className="canvas-agent-selection-chip-leading" aria-hidden="true">{icon}</span>
            <span className="canvas-agent-selection-chip-label">{label}</span>
            <button
                type="button"
                className="canvas-agent-selection-chip-remove"
                disabled={disabled}
