...
import { canvasResourceMentionToken, mergeCanvasResourceReferenceCandidates, selectVideoReferenceCandidates, type CanvasResourceReference } from "@/lib/canvas/canvas-resource-references";
...
export function CanvasNodePromptPanel({
    ...
    const insertPromptReference = (expanded: boolean, reference: CanvasResourceReference) => {
        promptEditor(expanded).replaceSelection(`${canvasResourceMentionToken(reference)} `);
    };
