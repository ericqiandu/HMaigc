...
export async function applyWorkspaceSession(payload: AuthSessionPayload) {
    ...
    await startUserSession({
        restoreLocalSession: async () => {
            ...
            if (remoteUserId) installRemoteUserDataAutoSync();
        },
...
export function clearWorkspaceSessionMemory() {
    resetRemoteUserDataSync();
