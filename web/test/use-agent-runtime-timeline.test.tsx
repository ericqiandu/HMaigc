...
function uiItemEvent(sequence: number, kind: "item.delta", payload: Record<string, unknown>): AgentRuntimeEvent {
    return { protocolVersion: 4, threadId: "thread-1", runId: "run-1", sequence, kind, itemId: "item-message-1", itemKind: "agent_message", payload, createdAt: "2026-08-18T00:00:02Z" };
}
