...
const canvasApplyOpsResultSchema = `{"type":"object","additionalProperties":false,"properties":{"canvasId":{"type":"string"},"baseRevision":{"type":"integer"},"committedRevision":{"type":"integer"},"clientMutationId":{"type":"string"},"appliedOperationIds":{"type":"array","items":{"type":"string"}}},"required":["canvasId","baseRevision","committedRevision","clientMutationId","appliedOperationIds"]}`
...
const mediaGenerateResultSchema = `{"type":"object","additionalProperties":false,"properties":{"taskId":{"type":"string"},"mediaKind":{"type":"string","enum":["image","video","audio"]},"clientRequestId":{"type":"string"}},"required":["taskId","mediaKind","clientRequestId"]}`
