...
func applyCanvasMutationPatch(
	...
	if err := validateUpsertedConnectionTypes(nodes, patch.UpsertConnections); err != nil {
		return "", "", err
	}
...
func validateUpsertedConnectionTypes(nodes []json.RawMessage, upserts []json.RawMessage) error {
