...
func defaultMembershipStorefrontSetting() MembershipStorefrontSetting {
	...
	return MembershipStorefrontSetting{
		...
		MembershipNotes:    []string{"免费用户登录每日赠送 20 积分；每日赠 2 次 5 折视频；云端存储空间 3GB。", "订阅积分每 31 天进行重置。"},
		FAQs: []MembershipStorefrontFAQ{
			{Question: "积分有效期规则", Answer: "订阅积分每 31 天进行重置，当期未使用完的积分不累计至下一周期。通过活动赠送、每日登录等方式获得的积分，有效期以具体活动规则为准，请在积分明细页面查看。"},
